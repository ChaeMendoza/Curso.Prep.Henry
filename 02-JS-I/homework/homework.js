...
function redondearNumero(num) {
  ...
  // Tu código:
  const rendondeo = Math.round(num);
  return rendondeo;
}
...
function esParOImpar(numero) {
  //La función va a recibir un entero. Devuelve como resultado una cadena de texto que indica si el número es par o impar. 
  //Si el número es par, devolver ---> "Es par"
  //Si el número es impar, devolver ---> "Es impar"
  //Si el número es 0, devuelve false
  if(numero % 2 === 0){
    return "Es par";
  }else if(numero % 2 !== 0){
